...
import { EmbDialogAfiliadosReporteComponent } from './emb-dialog-afiliados-reporte.component';
...
describe('EmbDialogAfiliadosReporteComponent', () => {
  let component: EmbDialogAfiliadosReporteComponent;
  let fixture: ComponentFixture<EmbDialogAfiliadosReporteComponent>;
  let user:IMainUser
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ EmbDialogAfiliadosReporteComponent ],
      imports:[MatTableExporterModule, ReactiveFormsModule],
      providers:[
        HttpClient, 
        HttpHandler,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EmbDialogAfiliadosReporteComponent);
  ...
  // it('when execute reporte excel', fakeAsync(()=> {
